...
export class NewsItem extends Component {
  // to convert to function based component remove this line by const NewsItem (props){
  ...
  render() {
    // we have to remove render() method

    let { title, description, imageUrl, newsUrl, author, date, source } =
      this.props; // we can remove this. from this.props
    return (
      <div className="my-3">
        <div className="card">
          <div
